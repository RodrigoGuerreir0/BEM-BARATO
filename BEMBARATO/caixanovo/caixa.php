...
<?php foreach ($codVenda as $linha2) { ?>
    <tr>
        <p class="txtinfoscaixa"><?php $linha2["id"] ?></p>
        <?php $ultimoCodVenda = $linha2["id"] ?>
    </tr>
<?php } ?>
                            ...
                            <form action="MetodoPagamento.php" method="post">
                                <fieldset class="ValorCompra">
                                    ...
                                    <div class="centralizarqtdgeral-main">
                                        ...
                                        <input type="hidden" name="valor_compra" id="ValorVenda" value="<?php echo $somaValores; ?>">
                                        <input type="hidden" name="id_venda" id="UltimoCodVenda" value="<?php echo $ultimoCodVenda; ?>">
                                    </div>
                                </fieldset>
...
<script>
    $('#finalizarCompra').click(function() {
        $.ajax({
            ...
            data: {
                processamento: '1',
                UltimoCodVenda: $("#UltimoCodVenda").val(),
